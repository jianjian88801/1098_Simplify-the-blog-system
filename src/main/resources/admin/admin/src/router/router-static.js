...
import center from '@/views/center'
    ...
    import dictionaryBokeNeirong from '@/views/modules/dictionaryBokeNeirong/list'
    import dictionaryBokeYesno from '@/views/modules/dictionaryBokeYesno/list'
...
const routes = [{
    ...
    ,{
        path: '/dictionaryBokeNeirong',
        name: '博客内容',
        component: dictionaryBokeNeirong
    }
    ,{
        path: '/dictionaryBokeYesno',
        name: '博客审核',
        component: dictionaryBokeYesno
    }
    ,{
